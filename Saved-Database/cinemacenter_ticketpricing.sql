...
CREATE TABLE `ticketpricing` (
  ...
  `hall_name` enum('Hall_A','Hall_B') COLLATE utf8mb4_unicode_ci NOT NULL,
  `base_price` decimal(10,2) NOT NULL,
  `discount_rate` decimal(5,2) DEFAULT '50.00',
  PRIMARY KEY (`id`)
...
INSERT INTO `ticketpricing` VALUES (1,'Hall_A',10.00,50.00),(2,'Hall_B',20.00,50.00);
